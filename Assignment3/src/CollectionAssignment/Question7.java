...
public class Question7  {
	public static void main(String[] args) {
		...
		Student s1 = new Student(12, "amol", "A", 492);
		Student s2 = new Student(21, "rahul", "A", 384);
		Student s3 = new Student(9, "varsha", "c", 165);
		Student s4 = new Student(38, "vaibhav", "B", 244);
		Student s5 = new Student(41, "suraj", "D", 350);
