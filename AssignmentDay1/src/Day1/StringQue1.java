//Create a program in which two string is input by the user and after that user will enter index in first string where we want to insert the second string 
...
public class StringQue1 {
	...
	public static void main(String[] args) {
		...
		{
			StringQue1 program1=new StringQue1();
